...
module UniversalImporter
  ...
  class Import
    ...
    # Backups, from the intermediate MTL file, the materials names indexed by texture path.
    #
    # @see ModelObserver#onPlaceComponent
    def backup_materials_names_for_later
      intermediate_mtl = MTL.new(@inter_mtl_file_path)

      # Materials names indexed by texture path.
      @materials_names = {}
      ...
      intermediate_mtl.materials.each { |material_name, material|
        ...
        # @todo Find a way to backup the name of a material only made of a color.
      }
